		...
		<div class="row">
			<div class="col-lg-10 col-xl-9 mx-auto">
				<div class="card card-signin flex-row my-5">
					...
					<div class="card-body">
						<h5 class="card-title text-center">What You Want To Update</h5>
						<form class="form-signin" method="post" action="registeruser">
							<input type="hidden" name="id" value="${user.id}" />
							<div class="form-label-group">
								<input type="text" name="name" value="${user.getName()}" id="inputUserame"
									class="form-control" placeholder="Name" required autofocus>
								<label for="inputUserame">Name</label>
							</div>

							<div class="form-label-group">
								<input type="text" name="username" value="${user.getUsername()}" id="inputEmail"
									class="form-control" placeholder="Username" required> <label
									for="inputEmail">Username</label>
							</div>

							<div class="form-label-group">
								<input type="email" name="email" value="${user.getEmail()}" id="inputEmail"
							...
							<div class="form-label-group">
								<input type="password" name="password" id="inputPassword"
									class="form-control" placeholder="Password" value="${user.getPassword()}" required> <label
									for="inputPassword">Password</label>
							</div>
							<div class="form-label-group">
								<input type="text" name="age" value="${user.getAge()}" id="inputPassword"
