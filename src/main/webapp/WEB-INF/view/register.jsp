					...
					<div class="card-body">
						...
						<form class="form-signin" method="post" action="registeruser">
							...
							<div class="form-label-group">
								<input type="text" name="name" value="${user.name}" id="inputUserame"
									class="form-control" placeholder="Name" required autofocus>
								<label for="inputUserame">Name</label>
							</div>

							<div class="form-label-group">
								<input type="text" name="username" value="${user.username}" id="inputEmail"
									class="form-control" placeholder="Username" required> <label
									for="inputEmail">Username</label>
							</div>

							<div class="form-label-group">
								<input type="email" name="email" value="${user.email}" id="inputEmail"
							...
							<div class="form-label-group">
								<input type="password" name="password" id="inputPassword"
									class="form-control" placeholder="Password" value="${user.password}" required> <label
									for="inputPassword">Password</label>
							</div>
							<div class="form-label-group">
								<input type="text" name="age" value="${user.age}" id="inputPassword"
									class="form-control" placeholder="Your Age" required> <label
									for="inputPassword">Your Age</label>
							</div>


							<button class="btn btn-lg btn-primary btn-block text-uppercase"
								type="submit">Register</button>
							<a class="d-block text-center mt-2 small" href="/login">Have
								Account? SignIn Here</a>
							<hr class="my-4">
